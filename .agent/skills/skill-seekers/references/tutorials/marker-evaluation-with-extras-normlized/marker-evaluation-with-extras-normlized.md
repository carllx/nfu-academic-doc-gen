# How To: Marker Evaluation With Extras Normlized
...
```python
Foo = Distribution.from_filename('/foo_dir/Foo-1.2.dist-info', metadata=Metadata(('METADATA', "Provides-Extra: baz-lightyear\nRequires-Dist: quux; extra=='baz-lightyear'")))
```
...
*Source: test_resources.py:270 | Complexity: Advanced | Last updated: 2026-06-02*