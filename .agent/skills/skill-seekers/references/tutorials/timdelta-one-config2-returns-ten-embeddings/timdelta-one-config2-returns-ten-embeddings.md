# How To: Timdelta One Config2 Returns Ten Embeddings
...
Workflow: test timdelta one config2 returns ten embeddings
...
### Step 3: Assign G1 = put_time_config_2(...)
...
### Step 7: Assign L = list(...)

```python
L = list(gm.subgraph_isomorphisms_iter())
```

### Step 8: Assign count_match = len(...)
...
*Source: test_temporalisomorphvf2.py:139 | Complexity: Advanced | Last updated: 2026-06-02*