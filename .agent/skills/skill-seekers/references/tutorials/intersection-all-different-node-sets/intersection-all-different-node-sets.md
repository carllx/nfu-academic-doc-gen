# How To: Intersection All Different Node Sets
...
Workflow: test intersection all different node sets
...
### Step 13: Call R.add_edge()

```python
R.add_edge(4, 1)
```

### Step 14: Call R.add_edge()

```python
R.add_edge(8, 9)
```

### Step 15: Assign I = nx.intersection_all(...)
...
*Source: test_all.py:53 | Complexity: Advanced | Last updated: 2026-06-02*