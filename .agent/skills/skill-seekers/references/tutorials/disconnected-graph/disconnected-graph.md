...
Workflow: Test for a graph with multiple connected components.
...
### Step 1: 'Test for a graph with multiple connected components.'
...
*Source: test_chains.py:97 | Complexity: Advanced | Last updated: 2026-06-02*